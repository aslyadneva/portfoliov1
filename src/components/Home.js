...
const navSocials = [
  <FaGithub site="github" url="https://github.com/aslyadneva" />,
  <FaLinkedin
    url="https://www.linkedin.com/in/anastasia-slyadneva"
    site="linkedin"
  />,
];
      ...
      <main className="Home__main">
        ...
        <div className="Home__content">
          ...
          >
            <Lead title="Hello" />
            <p>
              Hi there! I'm Anastasia, a front-end developer based in Dallas,
              TX. <br />I love to learn new technologies and bring beautiful
